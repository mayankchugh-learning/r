...
| --- | --- | --- | --- | --- | --- |
| [Notion](https://github.com/raycast/extensions/tree/main/extensions/notion) | 246,871 | The fastest way to search, create and update Notion pages. | notion (org) | Windows, macOS | [store](https://www.raycast.com/notion/notion) |
...
| [Capacities](https://github.com/raycast/extensions/tree/main/extensions/capacities) | 6,172 | Interact with Capacities from your command bar. Search your notes, capture content & more. | steffenble | macOS, Windows | [store](https://www.raycast.com/steffenble/capacities) |
...
| [Todo List](https://github.com/raycast/extensions/tree/main/extensions/todo-list) | 17,262 | Manage your todo list quickly by adding items and marking items as completed. | maggie | macOS, Windows | [store](https://www.raycast.com/maggie/todo-list) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Raycast Explorer](https://github.com/raycast/extensions/tree/main/extensions/raycast-explorer) | 40,625 | Explore snippets, prompts, and custom themes from within Raycast. | raycast (org) | macOS, Windows | [store](https://www.raycast.com/raycast/raycast-explorer) |
...
| [Apple Maps Search](https://github.com/raycast/extensions/tree/main/extensions/apple-maps-search) | 16,638 | Quickly search Apple Maps or find directions. | djpowers | macOS, Windows | [store](https://www.raycast.com/djpowers/apple-maps-search) |

### Files, Sync & Upload

| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Instagram Media Downloader](https://github.com/raycast/extensions/tree/main/extensions/instagram-media-downloader) | 6,459 | Download media from Instagram with ease | ridemountainpig | macOS, Windows | [store](https://www.raycast.com/ridemountainpig/instagram-media-downloader) |
...
| [Parcel](https://github.com/raycast/extensions/tree/main/extensions/parcel) | 2,894 | Allow Parcel users to see upcoming and active deliveries | marcmagn1 | macOS, Windows | [store](https://www.raycast.com/marcmagn1/parcel) |
| [TypeWhisper](https://github.com/raycast/extensions/tree/main/extensions/typewhisper) | 2,711 | Voice dictation, transcription history, and profile management for TypeWhisper | SeoFood | macOS, Windows | [store](https://www.raycast.com/SeoFood/typewhisper) |
