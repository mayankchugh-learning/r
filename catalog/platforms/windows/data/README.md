...
| [Random Data Generator](https://github.com/raycast/extensions/tree/main/extensions/random-data-generator) | 32,867 | Generate random data using Faker library | loris | macOS, Windows | [store](https://www.raycast.com/loris/random) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Workouts](https://github.com/raycast/extensions/tree/main/extensions/workouts) | 1,937 | Stay on top of your workouts from Strava | samuelkraft | macOS, Windows | [store](https://www.raycast.com/samuelkraft/workouts) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Bible](https://github.com/raycast/extensions/tree/main/extensions/bible) | 2,864 | Search the bible | josmithua | macOS, Windows | [store](https://www.raycast.com/josmithua/bible) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Wolfram Alpha](https://github.com/raycast/extensions/tree/main/extensions/wolfram-alpha) | 9,105 | Query Wolfram Alpha right from Raycast | mathieudutour | macOS, Windows | [store](https://www.raycast.com/mathieudutour/wolfram-alpha) |
