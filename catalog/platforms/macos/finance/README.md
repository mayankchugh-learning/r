...
| --- | --- | --- | --- | --- | --- |
| [Stock Tracker](https://github.com/raycast/extensions/tree/main/extensions/stock-tracker) | 5,676 | Shows stock market data for individual stocks or your portfolio by using Yahoo Finance. | hmarr | macOS | [store](https://www.raycast.com/hmarr/stock-tracker) |
| [Stock Lookup](https://github.com/raycast/extensions/tree/main/extensions/stock-lookup) | 1,945 | Retrieves stock information from the alphavantage API. Get a free API Key from https://www.alphavantage.co/support/#api-key, or a paid one from https://www.alp… | jones-sam | macOS | [store](https://www.raycast.com/jones-sam/stock-lookup) |
| [Apple Stocks Search](https://github.com/raycast/extensions/tree/main/extensions/apple-stocks-search) | 1,047 | Apple Stocks Extension for Raycast with Autosuggestions | hayden_barnes | macOS | [store](https://www.raycast.com/hayden_barnes/apple-stocks-search) |
...
| [Polymarket](https://github.com/raycast/extensions/tree/main/extensions/polymarket) | 292 | Search and view markets on Polymarket | Osprey | macOS | [store](https://www.raycast.com/Osprey/polymarket) |
| [Position Size Calculator](https://github.com/raycast/extensions/tree/main/extensions/position-size-calculator) | 155 | The Position Size Calculator is a Raycast extension designed to help traders quickly and accurately determine the appropriate position size for their trades. I… | akhilesh_dalvi | macOS | [store](https://www.raycast.com/akhilesh_dalvi/position-size-calculator) |
| [Google Finance](https://github.com/raycast/extensions/tree/main/extensions/google-finance) | 142 | Track stock prices powered by Google Finance | kyle_samani | macOS | [store](https://www.raycast.com/kyle_samani/google-finance) |
...
| [Kalshi](https://github.com/raycast/extensions/tree/main/extensions/kalshi) | 123 | Search, filter, and favorite prediction markets on Kalshi | Osprey | macOS, Windows | [store](https://www.raycast.com/Osprey/kalshi) |
...
| [Midas](https://github.com/raycast/extensions/tree/main/extensions/midas) | 44 | Midas is an AI Agent that manages on-chain trading, voting and more for you. | sunosuporno | macOS | [store](https://www.raycast.com/sunosuporno/midas) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Coinmarketcap Crypto Search](https://github.com/raycast/extensions/tree/main/extensions/coinmarketcap-crypto-crawler) | 5,136 | A price crawler to search crypto price from Coinmarketcap. | SonicSpark | macOS | [store](https://www.raycast.com/SonicSpark/coinmarketcap-crypto-price-crawler) |
| [Coingecko](https://github.com/raycast/extensions/tree/main/extensions/coingecko) | 2,585 | Get crypto data from Coingecko (price, ticker, ranking) | destiner | macOS | [store](https://www.raycast.com/destiner/coingecko) |
...
| [Crypto Price](https://github.com/raycast/extensions/tree/main/extensions/crypto-price) | 1,004 | Keep an eye on Bitcoin (BTC), Ethereum (ETH), and other cryptocurrency prices and more directly from your system menu bar | gutenye | macOS, Windows | [store](https://www.raycast.com/gutenye/crypto-price) |
...
| [Solana Explorer](https://github.com/raycast/extensions/tree/main/extensions/solana-explorer) | 212 | Look up transactions and accounts on the various Solana clusters. | darklong | macOS | [store](https://www.raycast.com/darklong/solana-explorer) |
...
| [Crypto Portfolio Tracker](https://github.com/raycast/extensions/tree/main/extensions/crypto-portfolio-tracker) | 74 | Add crypto wallets by their addresses and track your entire portfolio. | narghev | macOS, Windows | [store](https://www.raycast.com/narghev/crypto-portfolio-tracker) |
| [Portfolio Tracker](https://github.com/raycast/extensions/tree/main/extensions/portfolio-tracker) | 61 | Track value of your Stocks, ETFs, Properties, Cash, Debt and Crypto with automatic price updates over time to see your net worth | filipawaits | macOS | [store](https://www.raycast.com/filipawaits/portfolio-tracker) |
| [Solana Wallets Generation](https://github.com/raycast/extensions/tree/main/extensions/solana-wallets-generation) | 49 | Introducing the Solana Wallet Generator, a powerful Raycast extension designed for developers and cryptocurrency enthusiasts seeking to efficiently create mult… | uladkaminski | macOS | [store](https://www.raycast.com/uladkaminski/solana-wallets-generation) |
| [Hashrate](https://github.com/raycast/extensions/tree/main/extensions/hashrate-no) | 48 | Crypto mining resources via Hashrate.no | xmok | macOS | [store](https://www.raycast.com/xmok/hashrate-no) |
...
| [Starling](https://github.com/raycast/extensions/tree/main/extensions/starling) | 15 | Securely manage Starling accounts with your own personal access token | lemikeone | macOS, Windows | [store](https://www.raycast.com/lemikeone/starling) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Currency Exchange](https://github.com/raycast/extensions/tree/main/extensions/currency-exchange) | 17,608 | Simple Currency Exchange with a selectable rate provider (ExchangeRate-API or UniRateAPI) | xeric | Windows, macOS | [store](https://www.raycast.com/xeric/currency-exchange) |
| [Wise Quotes](https://github.com/raycast/extensions/tree/main/extensions/wise-quotes) | 664 | Effortlessly calculate international money transfers between USD and any target currency using the Wise API. Instantly generate quotes, access exchange rates,… | hugoliconv | macOS | [store](https://www.raycast.com/hugoliconv/wise-quotes) |
...
| [Chinese Converter](https://github.com/raycast/extensions/tree/main/extensions/chinese-converter) | 5 | Convert number input into Chinese formatted text, including uppercase RMB amount text. | tofrankie | macOS, Windows | [store](https://www.raycast.com/tofrankie/chinese-converter) |
| [XPF to EUR Converter](https://github.com/raycast/extensions/tree/main/extensions/xpf-converter) | 4 | Convert Franc Pacifique (XPF) to Euros (EUR) with instant clipboard copy | vincent_perrot | macOS | [store](https://www.raycast.com/vincent_perrot/xpf-converter) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Splitwise](https://github.com/raycast/extensions/tree/main/extensions/Splitwise) | 406 | View the balances and add expenses to Splitwise | ilian | macOS | [store](https://www.raycast.com/ilian/splitwise) |
| [Better Deal](https://github.com/raycast/extensions/tree/main/extensions/better-deal) | 292 | Calculates unit costs and tracks purchasing history to help you find the best deals. | juxtdesigncc | macOS | [store](https://www.raycast.com/juxtdesigncc/better-deal) |
...
| [Lunch Money](https://github.com/raycast/extensions/tree/main/extensions/lunchmoney) | 75 | Unofficial Lunch Money extension to manage your personal finances. | oppenheimer | macOS | [store](https://www.raycast.com/oppenheimer/lunchmoney) |
...
| [Toncoin (TON) Price](https://github.com/raycast/extensions/tree/main/extensions/toncoin-price) | 32 | Keep an eye on Toncoin (TON) cryptocurrency price directly from your system menu bar | arthurn | macOS | [store](https://www.raycast.com/arthurn/toncoin-price) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Monzo](https://github.com/raycast/extensions/tree/main/extensions/monzo) | 275 | View your Monzo bank account balance and recent transactions. | danpalmer | macOS | [store](https://www.raycast.com/danpalmer/monzo) |
...
| [Loan Calculator](https://github.com/raycast/extensions/tree/main/extensions/loan-calculator) | 169 | Calculate loan payments with customizable terms and payment schedules | kylinwowo | macOS | [store](https://www.raycast.com/kylinwowo/loan-calculator) |
| [Monse - Banking In Raycast](https://github.com/raycast/extensions/tree/main/extensions/monse) | 144 | Connect your bank account and see latest incomes, expenses, and details. | Falcon | macOS | [store](https://www.raycast.com/Falcon/monse) |
...
| [VietQR Transfer Generator](https://github.com/raycast/extensions/tree/main/extensions/vietqr-transfer) | 8 | Quickly generate VietQR payment codes for Vietnamese banks with customizable templates, amounts, and descriptions. | annguyen | macOS, Windows | [store](https://www.raycast.com/annguyen/vietqr-transfer) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Stripe](https://github.com/raycast/extensions/tree/main/extensions/stripe) | 1,238 | Quick Stripe dashboard functionality and quick link access | pradeepb28 | macOS, Windows | [store](https://www.raycast.com/pradeepb28/stripe) |
| [Mercury](https://github.com/raycast/extensions/tree/main/extensions/mercury) | 251 | Quickly see your Mercury accounts and transactions directly in Raycast | atkinsmatt101 | macOS | [store](https://www.raycast.com/atkinsmatt101/mercury) |
...
| [Gumroad Sales](https://github.com/raycast/extensions/tree/main/extensions/gumroad) | 80 | View your sales and products from Gumroad | eddiesigner | macOS, Windows | [store](https://www.raycast.com/eddiesigner/gumroad) |
| [Subflow](https://github.com/raycast/extensions/tree/main/extensions/subflow) | 64 | Manage your subscriptions with Subflow | ridemountainpig | macOS, Windows | [store](https://www.raycast.com/ridemountainpig/subflow) |
...
| [Subscription Manager](https://github.com/raycast/extensions/tree/main/extensions/subscription-manager) | 50 | Track and manage all your recurring subscriptions | shivraj-roy | macOS, Windows | [store](https://www.raycast.com/shivraj-roy/subscription-manager) |
| [FreeAgent](https://github.com/raycast/extensions/tree/main/extensions/freeagent) | 49 | Interact with FreeAgent | SteveEdson | macOS, Windows | [store](https://www.raycast.com/SteveEdson/freeagent) |
...
| [PayPal Invoices](https://github.com/raycast/extensions/tree/main/extensions/paypal-invoices) | 6 | Create and send PayPal invoices without leaving Raycast. | ethananderstandable | macOS, Windows | [store](https://www.raycast.com/ethananderstandable/paypal-invoices) |
| [SaaSFlow](https://github.com/raycast/extensions/tree/main/extensions/saasflow) | 2 | Track MRR, browse customers and transactions, and ask AI questions about your SaaSFlow data — without leaving Raycast. | saasflow (org) | macOS | [store](https://www.raycast.com/saasflow/saasflow) |
| [Contra](https://github.com/raycast/extensions/tree/main/extensions/contra) | 0 | Track Contra finances, create and send invoices, and manage freelance projects — right from Raycast. | agusdellaquila | macOS, Windows | [store](https://www.raycast.com/agusdellaquila/contra) |

### Regional & Company Lookups

| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [VAT Calculator](https://github.com/raycast/extensions/tree/main/extensions/vat-calculator) | 406 | Quickly calculates the VAT of a given value. By default, uses 16%, but the percentage can be adjusted. You can input either a number or an equation | justiniscoding | macOS | [store](https://www.raycast.com/justiniscoding/vat-calculator) |
...
| [TradingView Controls](https://github.com/raycast/extensions/tree/main/extensions/tradingview-controls) | 1,408 | Controls TradingView from within Raycast | skaj | macOS | [store](https://www.raycast.com/skaj/tradingview-controls) |
| [Raynab — Manage Your Budgets](https://github.com/raycast/extensions/tree/main/extensions/raynab) | 1,351 | View and manage your YNAB Budgets directly from Raycast | CodetaroMiura | macOS | [store](https://www.raycast.com/CodetaroMiura/raynab) |
...
| [Summation - Sum Calculator](https://github.com/raycast/extensions/tree/main/extensions/summation) | 547 | Calculate the sum of a list of numbers in the selected text or clipboard. | monvelasquez | macOS | [store](https://www.raycast.com/monvelasquez/summation) |
| [Fake Financial Data](https://github.com/raycast/extensions/tree/main/extensions/fake-financial-data) | 383 | Generate fake financial data | andre-rd-rodrigues | macOS | [store](https://www.raycast.com/andre-rd-rodrigues/fake-financial-data) |
...
| [Wave](https://github.com/raycast/extensions/tree/main/extensions/wave) | 49 | Manage your Wave Businesses | xmok | macOS | [store](https://www.raycast.com/xmok/wave) |
...
| [Recurly](https://github.com/raycast/extensions/tree/main/extensions/recurly) | 25 | A smallish client for the Recurly API | bgnfu7re | macOS | [store](https://www.raycast.com/bgnfu7re/recurly) |
...
| [Security Search](https://github.com/raycast/extensions/tree/main/extensions/security-search) | 24 | Searches for securities via name to get the ISIN or via ISIN to get the name | benekuehn | macOS | [store](https://www.raycast.com/benekuehn/security-search) |
...
| [Sadaqah Box](https://github.com/raycast/extensions/tree/main/extensions/sadaqah-box) | 6 | Manage your charity boxes and sadaqahs | emircanerkul | macOS, Windows | [store](https://www.raycast.com/emircanerkul/sadaqah-box) |
