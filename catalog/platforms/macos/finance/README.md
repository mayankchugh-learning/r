...
| --- | --- | --- | --- | --- | --- |
| [Stock Tracker](https://github.com/raycast/extensions/tree/main/extensions/stock-tracker) | 6,538 | Shows stock market data for individual stocks or your portfolio by using Yahoo Finance. | hmarr | macOS | [store](https://www.raycast.com/hmarr/stock-tracker) |
| [Stock Lookup](https://github.com/raycast/extensions/tree/main/extensions/stock-lookup) | 2,139 | Retrieves stock information from the alphavantage API. Get a free API Key from https://www.alphavantage.co/support/#api-key, or a paid one from https://www.alp… | jones-sam | macOS | [store](https://www.raycast.com/jones-sam/stock-lookup) |
| [Apple Stocks Search](https://github.com/raycast/extensions/tree/main/extensions/apple-stocks-search) | 1,200 | Apple Stocks Extension for Raycast with Autosuggestions | hayden_barnes | macOS | [store](https://www.raycast.com/hayden_barnes/apple-stocks-search) |
...
| [Google Finance](https://github.com/raycast/extensions/tree/main/extensions/google-finance) | 211 | Track stock prices powered by Google Finance | kyle_samani | macOS | [store](https://www.raycast.com/kyle_samani/google-finance) |
| [Position Size Calculator](https://github.com/raycast/extensions/tree/main/extensions/position-size-calculator) | 183 | The Position Size Calculator is a Raycast extension designed to help traders quickly and accurately determine the appropriate position size for their trades. I… | akhilesh_dalvi | macOS | [store](https://www.raycast.com/akhilesh_dalvi/position-size-calculator) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Coinmarketcap Crypto Search](https://github.com/raycast/extensions/tree/main/extensions/coinmarketcap-crypto-crawler) | 5,543 | A price crawler to search crypto price from Coinmarketcap. | SonicSpark | macOS | [store](https://www.raycast.com/SonicSpark/coinmarketcap-crypto-price-crawler) |
| [Coingecko](https://github.com/raycast/extensions/tree/main/extensions/coingecko) | 2,791 | Get crypto data from Coingecko (price, ticker, ranking) | destiner | macOS | [store](https://www.raycast.com/destiner/coingecko) |
| [Binance Portfolio](https://github.com/raycast/extensions/tree/main/extensions/binance) | 1,147 | Track your Binance portfolio | grzegorzkrukowski | macOS | [store](https://www.raycast.com/grzegorzkrukowski/binance) |
| [Crypto Price](https://github.com/raycast/extensions/tree/main/extensions/crypto-price) | 1,113 | Keep an eye on Bitcoin (BTC), Ethereum (ETH), and other cryptocurrency prices and more directly from your system menu bar | gutenye | macOS, Windows | [store](https://www.raycast.com/gutenye/crypto-price) |
| [Coinpaprika](https://github.com/raycast/extensions/tree/main/extensions/coinpaprika) | 833 | Cryptocurrency Prices & Statistics | gumbleliks | macOS | [store](https://www.raycast.com/gumbleliks/coinpaprika) |
...
| [Mempool](https://github.com/raycast/extensions/tree/main/extensions/mempool) | 179 | Get current bitcoin mempool information | dillionverma | macOS | [store](https://www.raycast.com/dillionverma/mempool) |
...
| [Vortex](https://github.com/raycast/extensions/tree/main/extensions/vortex) | 132 | The fastest way to use bitcoin on macOS | saunter | macOS | [store](https://www.raycast.com/saunter/vortex) |
...
| [Ticker Bar](https://github.com/raycast/extensions/tree/main/extensions/ticker-bar) | 14 | Track stocks, crypto, tokens, perpetual futures, and prediction markets from the menu bar. | kays0x | macOS | [store](https://www.raycast.com/kays0x/ticker-bar) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Currency Exchange](https://github.com/raycast/extensions/tree/main/extensions/currency-exchange) | 19,640 | Simple Currency Exchange with a selectable rate provider (ExchangeRate-API or UniRateAPI) | xeric | Windows, macOS | [store](https://www.raycast.com/xeric/currency-exchange) |
| [Wise Quotes](https://github.com/raycast/extensions/tree/main/extensions/wise-quotes) | 735 | Effortlessly calculate international money transfers between USD and any target currency using the Wise API. Instantly generate quotes, access exchange rates,… | hugoliconv | macOS | [store](https://www.raycast.com/hugoliconv/wise-quotes) |
...
| [Lunch Money](https://github.com/raycast/extensions/tree/main/extensions/lunchmoney) | 90 | Unofficial Lunch Money extension to manage your personal finances. | oppenheimer | macOS | [store](https://www.raycast.com/oppenheimer/lunchmoney) |
...
| [Wise Accounts](https://github.com/raycast/extensions/tree/main/extensions/wise-accounts) | 281 | View Wise Profiles, Balances, and Transactions | robsel118 | macOS | [store](https://www.raycast.com/robsel118/wise-accounts) |
...
| [Loan Calculator](https://github.com/raycast/extensions/tree/main/extensions/loan-calculator) | 203 | Calculate loan payments with customizable terms and payment schedules | kylinwowo | macOS | [store](https://www.raycast.com/kylinwowo/loan-calculator) |
| [Monse - Banking In Raycast](https://github.com/raycast/extensions/tree/main/extensions/monse) | 155 | Connect your bank account and see latest incomes, expenses, and details. | Falcon | macOS | [store](https://www.raycast.com/Falcon/monse) |
...
| [Mercury](https://github.com/raycast/extensions/tree/main/extensions/mercury) | 285 | Quickly see your Mercury accounts and transactions directly in Raycast | atkinsmatt101 | macOS | [store](https://www.raycast.com/atkinsmatt101/mercury) |
| [Polar](https://github.com/raycast/extensions/tree/main/extensions/polar) | 184 | Manage all your Polar products, sales & analytics | emilwidlund | macOS | [store](https://www.raycast.com/emilwidlund/polar) |
...
| [Subscription Manager](https://github.com/raycast/extensions/tree/main/extensions/subscription-manager) | 102 | Track and manage all your recurring subscriptions | shivraj-roy | macOS, Windows | [store](https://www.raycast.com/shivraj-roy/subscription-manager) |
...
| [Qonto](https://github.com/raycast/extensions/tree/main/extensions/qonto) | 67 | Search, download and open your Qonto from Raycast | christoribeiro | macOS | [store](https://www.raycast.com/christoribeiro/qonto) |
...
| [TradingView Controls](https://github.com/raycast/extensions/tree/main/extensions/tradingview-controls) | 1,587 | Controls TradingView from within Raycast | skaj | macOS | [store](https://www.raycast.com/skaj/tradingview-controls) |
...
| [Summation - Sum Calculator](https://github.com/raycast/extensions/tree/main/extensions/summation) | 621 | Calculate the sum of a list of numbers in the selected text or clipboard. | monvelasquez | macOS | [store](https://www.raycast.com/monvelasquez/summation) |
