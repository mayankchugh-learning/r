...
6 of 1094 extensions · [← macOS · Developer Tools](./README.md)

| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Jenkins](https://github.com/raycast/extensions/tree/main/extensions/jenkins) | 865 | Manage your Jenkins directly from Raycast. | k8scat | macOS | [store](https://www.raycast.com/k8scat/jenkins) |
| [Bitrise](https://github.com/raycast/extensions/tree/main/extensions/bitrise) | 437 | Check your Bitrise CI builds and start new ones. | ofalvai | macOS | [store](https://www.raycast.com/ofalvai/bitrise) |
