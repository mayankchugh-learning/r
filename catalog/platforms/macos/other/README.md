...
| [ElevenLabs TTS](https://github.com/raycast/extensions/tree/main/extensions/elevenlabs-tts) | 2,078 | Convert selected text to lifelike speech using ElevenLabs' premium AI voices | lachie_james | macOS | [store](https://www.raycast.com/lachie_james/elevenlabs-tts) |
| [Browser AI Companion](https://github.com/raycast/extensions/tree/main/extensions/browser-ai) | 2,023 | Use the best models with Raycast Browser Extension to extend your browsing experience. | lin | macOS | [store](https://www.raycast.com/lin/browser-ai) |
| [Query ChatGPT](https://github.com/raycast/extensions/tree/main/extensions/query-chatgpt) | 1,498 | Opens ChatGPT in your browser and executes your query in it | cyxn | macOS | [store](https://www.raycast.com/cyxn/query-chatgpt) |
...
| [Mood Tracker](https://github.com/raycast/extensions/tree/main/extensions/mood) | 423 | Track your mood, view glanceable charts and get insights with Raycast AI | vyacheslav | macOS | [store](https://www.raycast.com/vyacheslav/mood) |
...
| [Language Detector](https://github.com/raycast/extensions/tree/main/extensions/language-detector) | 237 | Detect languages through Raycast AI or third-party language detectors. | litomore | macOS, Windows | [store](https://www.raycast.com/litomore/language-detector) |
...
| [ICD10 Lookup](https://github.com/raycast/extensions/tree/main/extensions/icd10-lookup) | 83 | Shows matching ICD10 codes based on disease name input. Uses NLM's ICD10 API. | ubergraham | macOS | [store](https://www.raycast.com/ubergraham/icd10-lookup) |
...
| [Homepage](https://github.com/raycast/extensions/tree/main/extensions/homepage) | 431 | Homepage services and bookmarks in Raycast | bgiovand | macOS | [store](https://www.raycast.com/bgiovand/homepage) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [World Clock](https://github.com/raycast/extensions/tree/main/extensions/world-clock) | 7,988 | Query the current time of a region, ip or domain. | koinzhang | macOS, Windows | [store](https://www.raycast.com/koinzhang/world-clock) |
| [Premier League](https://github.com/raycast/extensions/tree/main/extensions/premier-league) | 2,823 | Get instant access to Premier League data right from your Raycast menu. Easily search for teams, players, fixtures, results, standings and awards. | anhthang | macOS, Windows | [store](https://www.raycast.com/anhthang/premier-league) |
| [HubSpot](https://github.com/raycast/extensions/tree/main/extensions/hubspot) | 1,552 | Search Hubspot Contacts, Companies and Deals | harisvsulaiman | macOS | [store](https://www.raycast.com/harisvsulaiman/hubspot) |
...
| [Y Combinator](https://github.com/raycast/extensions/tree/main/extensions/y-combinator) | 687 | Search all Y Combinator companies and get a countdown until demo day | thomas | macOS | [store](https://www.raycast.com/thomas/y-combinator) |
| [Save to Cubox](https://github.com/raycast/extensions/tree/main/extensions/save-to-cubox) | 493 | Save url or memo to your cubox | xyxc0673 | macOS | [store](https://www.raycast.com/xyxc0673/save-to-cubox) |
...
| [Drug Search](https://github.com/raycast/extensions/tree/main/extensions/drug-search) | 295 | Search the FDA drug database with ease | 0xdhrv | macOS, Windows | [store](https://www.raycast.com/0xdhrv/drug-search) |
| [Universities](https://github.com/raycast/extensions/tree/main/extensions/universities) | 144 | Search for universities worldwide | alewandowski | macOS | [store](https://www.raycast.com/alewandowski/universities) |
...
| [Scrycast](https://github.com/raycast/extensions/tree/main/extensions/scrycast) | 24 | Search for Magic: The Gathering cards on Scryfall or your collection | aayushpi | macOS | [store](https://www.raycast.com/aayushpi/scrycast) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Acqua](https://github.com/raycast/extensions/tree/main/extensions/acqua) | 833 | Acqua helps you remember to regularly drink water. | FezVrasta | macOS | [store](https://www.raycast.com/FezVrasta/acqua) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Home Assistant](https://github.com/raycast/extensions/tree/main/extensions/homeassistant) | 25,640 | Manage your smart home with Raycast | tonka3000 | macOS, Windows | [store](https://www.raycast.com/tonka3000/homeassistant) |
| [Hue](https://github.com/raycast/extensions/tree/main/extensions/hue) | 7,141 | Quickly and easily control Philips Hue lights | pindab0ter | macOS, Windows | [store](https://www.raycast.com/pindab0ter/hue) |
| [Govee](https://github.com/raycast/extensions/tree/main/extensions/govee) | 574 | Control your Govee Lights | j3lte | macOS | [store](https://www.raycast.com/j3lte/govee) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [The Movie Database](https://github.com/raycast/extensions/tree/main/extensions/tmdb) | 2,966 | Browse through hundreds of thousands of movies and tv shows, see new releases, parental guide and much more. | Aayush9029 | macOS | [store](https://www.raycast.com/Aayush9029/tmdb) |
| [Hellonext Wallpapers](https://github.com/raycast/extensions/tree/main/extensions/hellonext-wallpapers) | 1,339 | Download and set Hellonext's exclusive wallpapers. | karthik | macOS | [store](https://www.raycast.com/karthik/hellonext-wallpapers) |
...
| [MLB Scores](https://github.com/raycast/extensions/tree/main/extensions/mlb-scores) | 659 | Shows current MLB game scores. | jso8910 | macOS | [store](https://www.raycast.com/jso8910/mlb-scores) |
| [Imageflow](https://github.com/raycast/extensions/tree/main/extensions/image-flow) | 601 | Image Flow is a powerful optimization tool for images and files, enabling you to process them efficiently with workflows. | Godruoyi | macOS | [store](https://www.raycast.com/Godruoyi/image-flow) |
...
| [Binge Clock](https://github.com/raycast/extensions/tree/main/extensions/binge-clock) | 355 | Find out how long it takes to watch every episode in a TV series or every movie in a marathon. | Aayush9029 | macOS | [store](https://www.raycast.com/Aayush9029/binge-clock) |
| [Radarr](https://github.com/raycast/extensions/tree/main/extensions/radarr) | 332 | Manage your Radarr movie collection with powerful search, monitoring, and download management capabilities | xjo_nd | macOS | [store](https://www.raycast.com/xjo_nd/radarr) |
...
| [Fix Language](https://github.com/raycast/extensions/tree/main/extensions/fix-language) | 603 | Switch the language input source of the text when you type and forget to change the language. | tin5451 | macOS | [store](https://www.raycast.com/tin5451/fix-language) |
| [Korean Spell Checker](https://github.com/raycast/extensions/tree/main/extensions/korean-spell-checker) | 517 | Provides grammar/spelling suggestions for Korean language | jcha0713 | macOS | [store](https://www.raycast.com/jcha0713/korean-spell-checker) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Spaces](https://github.com/raycast/extensions/tree/main/extensions/spaces) | 5,314 | Declutter and organize your workspace in 1-click | pradeepb28 | macOS | [store](https://www.raycast.com/pradeepb28/spaces) |
...
| [Stoic Quotes](https://github.com/raycast/extensions/tree/main/extensions/stoicquotes) | 1,278 | Gives a random quote from one of the stoic philosophers - Marcus Aurelius, Seneca or Epictetus | rrajath | macOS | [store](https://www.raycast.com/rrajath/stoicquotes) |
...
| [Metronome](https://github.com/raycast/extensions/tree/main/extensions/metronome) | 1,025 | Based on an input (integer argument) BPM, you can get a metronome that plays a sound after a certain amount of time. | Visual-Studio-Coder | macOS | [store](https://www.raycast.com/Visual-Studio-Coder/metronome) |
| [Element](https://github.com/raycast/extensions/tree/main/extensions/element) | 1,012 | Show information about an element of the periodic table. | Aayush9029 | macOS | [store](https://www.raycast.com/Aayush9029/element) |
| [Raycast MonkeyType Theme Explorer](https://github.com/raycast/extensions/tree/main/extensions/raycast-monkeytype-theme) | 857 | This "Raycast MonkeyType Theme" extension provides MonkeyType themes for Raycast. | ridemountainpig | macOS | [store](https://www.raycast.com/ridemountainpig/raycast-monkeytype-theme) |
...
| [Moon Phrase](https://github.com/raycast/extensions/tree/main/extensions/moon-phrase) | 514 | Show details about the current moon phase, or put it in your menu bar. | bucketfish | macOS | [store](https://www.raycast.com/bucketfish/moon-phrase) |
...
| [Read Later](https://github.com/raycast/extensions/tree/main/extensions/later) | 375 | Read your tabs later | jimluo | macOS | [store](https://www.raycast.com/jimluo/later) |
...
| [Linak Desk Controller](https://github.com/raycast/extensions/tree/main/extensions/linak-controller) | 187 | Control the height of standing desks manufactured by Linak, for example the Ikea Idasen desk. | samuelkraft | macOS | [store](https://www.raycast.com/samuelkraft/linak-desk-controller) |
| [Linak Desk Controller](https://github.com/raycast/extensions/tree/main/extensions/linak-desk-controller) | 187 | Control the height of standing desks manufactured by Linak, for example the Ikea Idasen desk. | samuelkraft | macOS | [store](https://www.raycast.com/samuelkraft/linak-desk-controller) |
...
| [Guitar Tools](https://github.com/raycast/extensions/tree/main/extensions/guitar-tools) | 161 | A collection of tools for guitarists including a chromatic tuner. | narghev | macOS | [store](https://www.raycast.com/narghev/guitar-tools) |
...
| [Transfer.sh Uploader](https://github.com/raycast/extensions/tree/main/extensions/transfer-sh_upload) | 148 | Upload a file directly to a transfer.sh instance | PandaDEV | macOS | [store](https://www.raycast.com/PandaDEV/transfer-sh_upload) |
...
| [TV Remote](https://github.com/raycast/extensions/tree/main/extensions/tv-remote) | 17 | Control Sony BRAVIA TV picture settings | alexi.build | macOS | [store](https://www.raycast.com/alexi.build/tv-remote) |
| [Sage HR](https://github.com/raycast/extensions/tree/main/extensions/sage-hr) | 15 | Integration with Sage HR to get a searchable list on who is out today | cyxn | macOS | [store](https://www.raycast.com/cyxn/sage-hr) |
