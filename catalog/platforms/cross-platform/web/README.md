...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Remove Paywall](https://github.com/raycast/extensions/tree/main/extensions/remove-paywall) | 73,476 | Remove the paywall from the selected or clipboard URL. | tegola | macOS, Windows | [store](https://www.raycast.com/tegola/remove-paywall) |
...
| [IP Geolocation](https://github.com/raycast/extensions/tree/main/extensions/ip-geolocation) | 23,226 | Show local and public IPv4/IPv6 address. Query geolocation for any IP address or domain. | koinzhang | macOS, Windows | [store](https://www.raycast.com/koinzhang/ip-geolocation) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [XKCD Comics](https://github.com/raycast/extensions/tree/main/extensions/xkcd) | 4,299 | Browse the xkcd comics and keep track of the ones you've read. | maggie | macOS, Windows | [store](https://www.raycast.com/maggie/xkcd) |
...
| [Downdetector](https://github.com/raycast/extensions/tree/main/extensions/downdetector) | 17 | Instantly check if any service is down, see 24h report charts, and report problems — powered by Downdetector. | camille_maurel | macOS, Windows | [store](https://www.raycast.com/camille_maurel/downdetector) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Reddit Search](https://github.com/raycast/extensions/tree/main/extensions/reddit-search) | 21,710 | Search Reddit, Subreddits, or within Subreddits and list the results in Raycast. | ewlcheng | macOS, Windows | [store](https://www.raycast.com/ewlcheng/reddit-search) |
...
| [Karakeep](https://github.com/raycast/extensions/tree/main/extensions/karakeep) | 2,084 | A self-hostable bookmark-everything app (links, notes and images) with AI-based automatic tagging and full text search | luolei | macOS, Windows | [store](https://www.raycast.com/luolei/karakeep) |
...
| [MyIP](https://github.com/raycast/extensions/tree/main/extensions/myip) | 44,068 | My IP information | Kang | macOS, Windows | [store](https://www.raycast.com/Kang/myip) |
...
| [Readwise Reader](https://github.com/raycast/extensions/tree/main/extensions/readwise-reader) | 7,679 | Interact with Readwise Reader | zach | macOS, Windows | [store](https://www.raycast.com/zach/readwise-reader) |
...
| [WordReference Dictionary Translation](https://github.com/raycast/extensions/tree/main/extensions/wordreference) | 1,053 | Quickly find a word translation using WordReference | Katatsu | macOS, Windows | [store](https://www.raycast.com/Katatsu/wordreference) |
...
| [Reader Mode](https://github.com/raycast/extensions/tree/main/extensions/reader-mode) | 379 | Read the web distraction-free in Raycast. | chrismessina | macOS, Windows | [store](https://www.raycast.com/chrismessina/reader-mode) |
