...
| --- | --- | --- | --- | --- | --- |
| [Transmit](https://github.com/raycast/extensions/tree/main/extensions/transmit) | 2,119 | Displays a list of servers bookmarked in Transmit for quick connecting. | kennonb | macOS | [store](https://www.raycast.com/kennonb/transmit) |
...
| [Ploi](https://github.com/raycast/extensions/tree/main/extensions/ploi) | 465 | View and manage your ploi.io servers and sites | ploi (org) | macOS | [store](https://www.raycast.com/ploi/ploi) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Flush DNS](https://github.com/raycast/extensions/tree/main/extensions/flush-dns) | 12,650 | Flush the DNS cache | rasmusbe | macOS, Windows | [store](https://www.raycast.com/rasmusbe/flush-dns) |
| [Dig - DNS Lookup](https://github.com/raycast/extensions/tree/main/extensions/dig) | 3,988 | DNS lookup and nameserver query using the built-in host command | danielbahl | macOS | [store](https://www.raycast.com/danielbahl/dig) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Amazon AWS](https://github.com/raycast/extensions/tree/main/extensions/amazon-aws) | 9,770 | The best way to interact with your AWS resources | Falcon | macOS | [store](https://www.raycast.com/Falcon/aws) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Docker](https://github.com/raycast/extensions/tree/main/extensions/docker) | 45,708 | Manage Docker with Raycast | priithaamer | macOS, Windows | [store](https://www.raycast.com/priithaamer/docker) |
| [Docker Hub](https://github.com/raycast/extensions/tree/main/extensions/dockerhub) | 5,909 | Docker Hub extension for Raycast | k8scat | macOS | [store](https://www.raycast.com/k8scat/dockerhub) |
...
| [Kubernetes](https://github.com/raycast/extensions/tree/main/extensions/kubernetes) | 966 | Kubernetes Client in Raycast | justin0u0 | macOS | [store](https://www.raycast.com/justin0u0/kubernetes) |
