...
| [Ngrok](https://github.com/raycast/extensions/tree/main/extensions/ngrok) | 979 | Serve Web Apps with one command ngrok is a simplified API-first ingress-as-a-service that adds connectivity, security, and observability to your apps in one li… | ubinatus | macOS | [store](https://www.raycast.com/ubinatus/ngrok) |
...
| [rhttp](https://github.com/raycast/extensions/tree/main/extensions/rhttp) | 223 | Full-featured HTTP client with environments, variables, and request chaining | SebastianJarsve | macOS | [store](https://www.raycast.com/SebastianJarsve/rhttp) |
...
| [Ray Boop](https://github.com/raycast/extensions/tree/main/extensions/ray-boop) | 521 | Port of Boop to Raycast. Run any Boop script on clipboard content. | nathan_schwermann | macOS | [store](https://www.raycast.com/nathan_schwermann/ray-boop) |
...
| [Toggle Proxy](https://github.com/raycast/extensions/tree/main/extensions/toggle-proxy) | 20 | Toggle SOCKS proxy, manage Xray configs, and convert VLESS URLs on macOS | kaidstor | macOS | [store](https://www.raycast.com/kaidstor/toggle-proxy) |
