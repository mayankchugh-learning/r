...
| [OpenRouter Manager](https://github.com/raycast/extensions/tree/main/extensions/openrouter-manager) | 245 | View your OpenRouter credits and manage your API keys | ClaPalo | macOS, Windows | [store](https://www.raycast.com/ClaPalo/openrouter-manager) |
...
| [IPCheck](https://github.com/raycast/extensions/tree/main/extensions/ipcheck-ing) | 1,830 | Show All Your IPs, from Local Network and Multiple Sources | jason5ng32 | macOS | [store](https://www.raycast.com/jason5ng32/ipcheck-ing) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [cURL](https://github.com/raycast/extensions/tree/main/extensions/curl) | 25,053 | Keyboard-first HTTP client | jonathangiardino | macOS, Windows | [store](https://www.raycast.com/jonathangiardino/curl) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Port Manager](https://github.com/raycast/extensions/tree/main/extensions/port-manager) | 51,395 | Find open ports and close them | lucaschultz | macOS | [store](https://www.raycast.com/lucaschultz/port-manager) |
...
| [IP Tools](https://github.com/raycast/extensions/tree/main/extensions/ip-tools) | 3,586 | This is an extension plugin for converting, validating, and calculating IP subnets. (net, mask, netmask, ip2long, long2ip, cidr, ipv4, ipv6 & geoLocation) | meguoe | macOS, Windows | [store](https://www.raycast.com/meguoe/ip-tools) |
