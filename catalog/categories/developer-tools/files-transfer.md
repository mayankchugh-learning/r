...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Gitignore](https://github.com/raycast/extensions/tree/main/extensions/gitignore) | 3,748 | Quickly create a gitignore file for your project. | daniel-stoneuk | macOS, Windows | [store](https://www.raycast.com/daniel-stoneuk/gitignore) |
