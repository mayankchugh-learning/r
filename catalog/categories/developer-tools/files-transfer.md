...
| --- | --- | --- | --- | --- | --- |
| [Encoding Tools](https://github.com/raycast/extensions/tree/main/extensions/encoding-tools) | 4,838 | A toolbox for encoding, decoding, and hashing data in the clipboard. | eth-p | macOS | [store](https://www.raycast.com/eth-p/encoding-tools) |
...
| [UploadThing](https://github.com/raycast/extensions/tree/main/extensions/uploadthing) | 3,315 | Upload files in a single click | pingdotgg (org) | Windows, macOS | [store](https://www.raycast.com/pingdotgg/uploadthing) |
