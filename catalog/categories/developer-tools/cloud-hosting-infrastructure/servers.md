...
| [Proxmox](https://github.com/raycast/extensions/tree/main/extensions/proxmox) | 1,123 | Manage your Proxmox server from Raycast | CzBiX | Windows, macOS | [store](https://www.raycast.com/CzBiX/proxmox) |
...
| [Hop](https://github.com/raycast/extensions/tree/main/extensions/hop) | 117 | Fast, elegant SSH connection manager. Fuzzy search and connect to servers from your hop config. | danmartuszewski | macOS | [store](https://www.raycast.com/danmartuszewski/hop) |
| [Dev Servers](https://github.com/raycast/extensions/tree/main/extensions/dev-servers) | 113 | Project-grouped dashboard for every dev server running on your Mac. Start, restart, and kill them without leaving Raycast, with the framework (Next, Svelte, As… | tavlean | macOS | [store](https://www.raycast.com/tavlean/dev-servers) |
