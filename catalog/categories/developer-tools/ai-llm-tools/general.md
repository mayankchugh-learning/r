...
| [Claude](https://github.com/raycast/extensions/tree/main/extensions/claude) | 32,083 | Interact with Anthropic's Claude API directly from Raycast | florisdobber | macOS | [store](https://www.raycast.com/florisdobber/claude) |
