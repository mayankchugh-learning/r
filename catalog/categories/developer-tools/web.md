...
| --- | --- | --- | --- | --- | --- |
| [CyberChef](https://github.com/raycast/extensions/tree/main/extensions/cyberchef) | 9,198 | The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis | mblode | macOS | [store](https://www.raycast.com/mblode/cyberchef) |
