...
| [Run Script Kit Command](https://github.com/raycast/extensions/tree/main/extensions/script-kit) | 1,377 | Run Script Kit Command from Raycast | pomdtr | macOS | [store](https://www.raycast.com/pomdtr/script-kit) |

## General

| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Cron Description](https://github.com/raycast/extensions/tree/main/extensions/cron-description) | 3,378 | Convert cron expressions into human readable descriptions | niall-maloney | macOS, Windows | [store](https://www.raycast.com/niall-maloney/cron-description) |
