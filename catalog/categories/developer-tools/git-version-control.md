...
| [Git Worktrees](https://github.com/raycast/extensions/tree/main/extensions/worktrees) | 318 | View, add, and remove git worktrees. | canac | macOS | [store](https://www.raycast.com/canac/worktrees) |
| [Quick Git](https://github.com/raycast/extensions/tree/main/extensions/quick-git) | 312 | Quickly run git commands through Raycast | joshdales | macOS | [store](https://www.raycast.com/joshdales/quick-git) |
| [Git Worktrees](https://github.com/raycast/extensions/tree/main/extensions/git-worktrees) | 311 | Efficiently managing Git worktrees with actions for cloning, listing, adding, renaming and removing worktrees within projects | philstainer | macOS | [store](https://www.raycast.com/philstainer/git-worktrees) |
...
| [Quick Jump](https://github.com/raycast/extensions/tree/main/extensions/quick-jump) | 139 | Quick access to your team's Git repositories, dashboards, databases, and internal tools. | akadir | macOS | [store](https://www.raycast.com/akadir/quick-jump) |
...
| [Git Profile](https://github.com/raycast/extensions/tree/main/extensions/git-profile) | 45 | This extension is for managing Git user profiles. | tuki0918 | macOS | [store](https://www.raycast.com/tuki0918/git-profile) |
| [Git Batch Tools](https://github.com/raycast/extensions/tree/main/extensions/git-batch-tools) | 40 | Batch git operations (pull, status) across multiple project groups | Logan-8f | macOS, Windows | [store](https://www.raycast.com/Logan-8f/git-batch-tools) |
