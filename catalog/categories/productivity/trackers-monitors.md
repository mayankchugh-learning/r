...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Flight Tracker](https://github.com/raycast/extensions/tree/main/extensions/trackflight) | 3,327 | Track your flight with your flight number by using AeroData Box API directly in Raycast. | cojmeister | macOS | [store](https://www.raycast.com/cojmeister/trackflight) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Monkeytype](https://github.com/raycast/extensions/tree/main/extensions/monkeytype) | 1,329 | Quick access to Monkeytype sections - typing tests, stats, leaderboards, and settings | radouane-tamouss | macOS | [store](https://www.raycast.com/radouane-tamouss/monkeytype) |
...
| [DeepL API Usage](https://github.com/raycast/extensions/tree/main/extensions/deepl-api-usage) | 709 | Manage your DeepL API usage with ease. | jaredliu233 | macOS | [store](https://www.raycast.com/jaredliu233/deepl-api-usage) |
...
| [Cursor Costs](https://github.com/raycast/extensions/tree/main/extensions/cursor-costs) | 373 | Track your Cursor costs in real-time directly from macOS menu bar | shadeov | macOS | [store](https://www.raycast.com/Shadeov/cursor-costs) |
