...
| [OpenClaw](https://github.com/raycast/extensions/tree/main/extensions/openclaw) | 1,358 | Monitor and chat with your OpenClaw Gateway from Raycast | leveragedrobot | macOS | [store](https://www.raycast.com/leveragedrobot/openclaw) |
| [Codex](https://github.com/raycast/extensions/tree/main/extensions/codex) | 693 | Monitor and manage your Codex threads, MCPs, projects, and usage directly from Raycast. | asifk | macOS | [store](https://www.raycast.com/asifk/codex) |
...
| [EveryAPI](https://github.com/raycast/extensions/tree/main/extensions/everyapi) | 68 | Use 240+ LLMs through the EveryAPI gateway from Raycast — chat, switch models, and monitor account activity. | everyapi_dev | macOS, Windows | [store](https://www.raycast.com/everyapi_dev/everyapi) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Flight Tracker](https://github.com/raycast/extensions/tree/main/extensions/trackflight) | 3,731 | Track your flight with your flight number by using AeroData Box API directly in Raycast. | cojmeister | macOS | [store](https://www.raycast.com/cojmeister/trackflight) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Monkeytype](https://github.com/raycast/extensions/tree/main/extensions/monkeytype) | 1,675 | Quick access to Monkeytype sections - typing tests, stats, leaderboards, and settings | radouane-tamouss | macOS | [store](https://www.raycast.com/radouane-tamouss/monkeytype) |
