...
| [Floaty](https://github.com/raycast/extensions/tree/main/extensions/floaty) | 1,015 | Control Floaty from Raycast to list, pin, and manage windows. | fayecat | macOS | [store](https://www.raycast.com/fayecat/floaty) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Google Workspace](https://github.com/raycast/extensions/tree/main/extensions/google-workspace) | 53,340 | Access Google Drive files | raycast (org) | macOS, Windows | [store](https://www.raycast.com/raycast/google-workspace) |
