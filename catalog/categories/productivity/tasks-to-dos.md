...
| --- | --- | --- | --- | --- | --- |
| [Todoist](https://github.com/raycast/extensions/tree/main/extensions/todoist) | 84,632 | Check your Todoist tasks and quickly create new ones | doist (org) | macOS, Windows | [store](https://www.raycast.com/doist/todoist) |
| [TickTick](https://github.com/raycast/extensions/tree/main/extensions/ticktick) | 21,840 | Check and search tasks in TickTick via Raycast | appest | macOS | [store](https://www.raycast.com/appest/ticktick) |
| [Google Tasks](https://github.com/raycast/extensions/tree/main/extensions/google-tasks) | 9,932 | Manage Google Tasks from Raycast. | elliotdes | macOS, Windows | [store](https://www.raycast.com/elliotdes/google-tasks) |
...
| [ClickUp - Tasks & Docs Explorer](https://github.com/raycast/extensions/tree/main/extensions/clickup) | 8,354 | Browse ClickUp tasks and docs from Raycast | aparandeh | macOS | [store](https://www.raycast.com/aparandeh/manage-clickup-tasks) |
...
| [Codex](https://github.com/raycast/extensions/tree/main/extensions/codex) | 143 | Monitor and manage your Codex tasks directly from Raycast. | asifk | macOS | [store](https://www.raycast.com/asifk/codex) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Apple Reminders](https://github.com/raycast/extensions/tree/main/extensions/apple-reminders) | 102,520 | Manage Apple Reminders. | raycast (org) | macOS | [store](https://www.raycast.com/raycast/apple-reminders) |
| [Fantastical](https://github.com/raycast/extensions/tree/main/extensions/fantastical) | 19,311 | Create Fantastical events and reminders using Fantastical's natural language processing. | devahschaefers | macOS | [store](https://www.raycast.com/devahschaefers/fantastical) |
| [Simple Reminder](https://github.com/raycast/extensions/tree/main/extensions/simple-reminder) | 5,574 | Set your reminders in natural language without the need to have any application installed. | comoser | macOS | [store](https://www.raycast.com/comoser/simple-reminder) |
...
| Extension | Downloads | Description | Author | Platforms | Store |
| --- | --- | --- | --- | --- | --- |
| [Things](https://github.com/raycast/extensions/tree/main/extensions/things) | 37,257 | Search and manage your Things to-dos from Raycast | loris | macOS | [store](https://www.raycast.com/loris/things) |
...
| [OmniFocus](https://github.com/raycast/extensions/tree/main/extensions/omnifocus) | 1,753 | Perform basic actions on your OmniFocus database. | nicolas-marien | macOS | [store](https://www.raycast.com/nicolas-marien/omnifocus) |
