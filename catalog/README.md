...
**3194** extensions · **17** categories · **2131** publishers
...
| [By platform](./platforms/README.md) | macOS (3162) · Windows (862) · cross-platform (830), each by category |
| [By publisher](./publishers/README.md) | 2131 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,689 |
