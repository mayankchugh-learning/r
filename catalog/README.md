...
**3118** extensions · **17** categories · **2068** publishers
...
| [By platform](./platforms/README.md) | macOS (3089) · Windows (806) · cross-platform (777), each by category |
| [By publisher](./publishers/README.md) | 2068 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,646 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,381 |
| Creative & Media | Design Tools, Media | 406 |
| Web, Finance & News | Web, Finance, News | 653 |
| System & Utilities | System, Other | 429 |
| Fun & Entertainment | Fun | 274 |
