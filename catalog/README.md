...
**3168** extensions · **17** categories · **2112** publishers
...
| [By platform](./platforms/README.md) | macOS (3136) · Windows (843) · cross-platform (811), each by category |
| [By publisher](./publishers/README.md) | 2112 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,674 |
