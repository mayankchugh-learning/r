...
**3258** extensions · **17** categories · **2175** publishers
...
| [By platform](./platforms/README.md) | macOS (3226) · Windows (895) · cross-platform (863), each by category |
| [By publisher](./publishers/README.md) | 2175 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,729 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,433 |
| Creative & Media | Design Tools, Media | 429 |
| Web, Finance & News | Web, Finance, News | 672 |
| System & Utilities | System, Other | 448 |
