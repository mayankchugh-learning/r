...
**3252** extensions · **17** categories · **2169** publishers
...
| [By platform](./platforms/README.md) | macOS (3220) · Windows (891) · cross-platform (859), each by category |
| [By publisher](./publishers/README.md) | 2169 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,723 |
