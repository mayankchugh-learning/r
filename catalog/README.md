...
**3211** extensions · **17** categories · **2143** publishers
...
| [By platform](./platforms/README.md) | macOS (3179) · Windows (871) · cross-platform (839), each by category |
| [By publisher](./publishers/README.md) | 2143 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,701 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,416 |
| Creative & Media | Design Tools, Media | 424 |
| Web, Finance & News | Web, Finance, News | 667 |
| System & Utilities | System, Other | 438 |
