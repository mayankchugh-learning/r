...
**3126** extensions · **17** categories · **2075** publishers
...
| [By platform](./platforms/README.md) | macOS (3097) · Windows (812) · cross-platform (783), each by category |
| [By publisher](./publishers/README.md) | 2075 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,649 |
