...
**3152** extensions · **17** categories · **2098** publishers
...
| [By platform](./platforms/README.md) | macOS (3120) · Windows (830) · cross-platform (798), each by category |
| [By publisher](./publishers/README.md) | 2098 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,668 |
