...
**3176** extensions · **17** categories · **2119** publishers
...
| [By platform](./platforms/README.md) | macOS (3144) · Windows (848) · cross-platform (816), each by category |
| [By publisher](./publishers/README.md) | 2119 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,680 |
