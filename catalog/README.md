...
**3306** extensions · **17** categories · **2216** publishers
...
| [By platform](./platforms/README.md) | macOS (3271) · Windows (924) · cross-platform (889), each by category |
| [By publisher](./publishers/README.md) | 2216 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,757 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,453 |
