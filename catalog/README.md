...
**3143** extensions · **17** categories · **2089** publishers
...
| [By platform](./platforms/README.md) | macOS (3111) · Windows (824) · cross-platform (792), each by category |
| [By publisher](./publishers/README.md) | 2089 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,661 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,391 |
| Creative & Media | Design Tools, Media | 413 |
| Web, Finance & News | Web, Finance, News | 657 |
| System & Utilities | System, Other | 432 |
| Fun & Entertainment | Fun | 275 |
