...
**3199** extensions · **17** categories · **2135** publishers
...
| [By platform](./platforms/README.md) | macOS (3167) · Windows (866) · cross-platform (834), each by category |
| [By publisher](./publishers/README.md) | 2135 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,693 |
