...
**3288** extensions · **17** categories · **2202** publishers
...
| [By platform](./platforms/README.md) | macOS (3254) · Windows (908) · cross-platform (874), each by category |
| [By publisher](./publishers/README.md) | 2202 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,747 |
