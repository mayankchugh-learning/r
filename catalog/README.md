...
**3151** extensions · **17** categories · **2097** publishers
...
| [By platform](./platforms/README.md) | macOS (3119) · Windows (830) · cross-platform (798), each by category |
| [By publisher](./publishers/README.md) | 2097 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,667 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,393 |
| Creative & Media | Design Tools, Media | 413 |
| Web, Finance & News | Web, Finance, News | 658 |
