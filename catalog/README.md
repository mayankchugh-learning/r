...
**3263** extensions · **17** categories · **2180** publishers
...
| [By platform](./platforms/README.md) | macOS (3231) · Windows (895) · cross-platform (863), each by category |
| [By publisher](./publishers/README.md) | 2180 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,732 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,436 |
