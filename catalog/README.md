...
**3119** extensions · **17** categories · **2069** publishers
...
| [By platform](./platforms/README.md) | macOS (3090) · Windows (806) · cross-platform (777), each by category |
| [By publisher](./publishers/README.md) | 2069 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,647 |
