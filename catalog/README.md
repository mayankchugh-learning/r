...
**3109** extensions · **17** categories · **2062** publishers
...
| [By platform](./platforms/README.md) | macOS (3080) · Windows (805) · cross-platform (776), each by category |
| [By publisher](./publishers/README.md) | 2062 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,639 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,379 |
