...
**3322** extensions · **17** categories · **2229** publishers
...
| [By platform](./platforms/README.md) | macOS (3286) · Windows (933) · cross-platform (897), each by category |
| [By publisher](./publishers/README.md) | 2229 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,768 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,459 |
| Creative & Media | Design Tools, Media | 434 |
| Web, Finance & News | Web, Finance, News | 681 |
| System & Utilities | System, Other | 453 |
| Fun & Entertainment | Fun | 280 |
