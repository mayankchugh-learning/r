...
**3300** extensions · **17** categories · **2210** publishers
...
| [By platform](./platforms/README.md) | macOS (3266) · Windows (919) · cross-platform (885), each by category |
| [By publisher](./publishers/README.md) | 2210 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,754 |
