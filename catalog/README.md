...
**3262** extensions · **17** categories · **2179** publishers
...
| [By platform](./platforms/README.md) | macOS (3230) · Windows (895) · cross-platform (863), each by category |
| [By publisher](./publishers/README.md) | 2179 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,731 |
