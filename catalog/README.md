...
**3162** extensions · **17** categories · **2106** publishers
...
| [By platform](./platforms/README.md) | macOS (3130) · Windows (837) · cross-platform (805), each by category |
| [By publisher](./publishers/README.md) | 2106 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,672 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,397 |
| Creative & Media | Design Tools, Media | 418 |
