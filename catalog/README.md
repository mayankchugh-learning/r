...
**3213** extensions · **17** categories · **2144** publishers
...
| [By platform](./platforms/README.md) | macOS (3181) · Windows (871) · cross-platform (839), each by category |
| [By publisher](./publishers/README.md) | 2144 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,703 |
