...
**3145** extensions · **17** categories · **2091** publishers
...
| [By platform](./platforms/README.md) | macOS (3113) · Windows (826) · cross-platform (794), each by category |
| [By publisher](./publishers/README.md) | 2091 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,662 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,392 |
