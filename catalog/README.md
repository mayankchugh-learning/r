...
**3159** extensions · **17** categories · **2104** publishers
...
| [By platform](./platforms/README.md) | macOS (3127) · Windows (837) · cross-platform (805), each by category |
| [By publisher](./publishers/README.md) | 2104 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,670 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,396 |
| Creative & Media | Design Tools, Media | 417 |
