...
**3222** extensions · **17** categories · **2149** publishers
...
| [By platform](./platforms/README.md) | macOS (3190) · Windows (879) · cross-platform (847), each by category |
| [By publisher](./publishers/README.md) | 2149 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,706 |
