...
**3127** extensions · **17** categories · **2076** publishers
...
| [By platform](./platforms/README.md) | macOS (3098) · Windows (812) · cross-platform (783), each by category |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,650 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,387 |
