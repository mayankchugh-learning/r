...
**3184** extensions · **17** categories · **2124** publishers
...
| [By platform](./platforms/README.md) | macOS (3152) · Windows (855) · cross-platform (823), each by category |
| [By publisher](./publishers/README.md) | 2124 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,682 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,409 |
| Creative & Media | Design Tools, Media | 420 |
| Web, Finance & News | Web, Finance, News | 662 |
