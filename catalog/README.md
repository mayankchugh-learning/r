...
**3268** extensions · **17** categories · **2184** publishers
...
| [By platform](./platforms/README.md) | macOS (3236) · Windows (899) · cross-platform (867), each by category |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,733 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,439 |
