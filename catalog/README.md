...
**3171** extensions · **17** categories · **2115** publishers
...
| [By platform](./platforms/README.md) | macOS (3139) · Windows (844) · cross-platform (812), each by category |
| [By publisher](./publishers/README.md) | 2115 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,677 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,402 |
