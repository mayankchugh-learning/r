...
**3112** extensions · **17** categories · **2064** publishers
...
| [By platform](./platforms/README.md) | macOS (3083) · Windows (805) · cross-platform (776), each by category |
| [By publisher](./publishers/README.md) | 2064 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,641 |
