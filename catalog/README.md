...
**3106** extensions · **17** categories · **2059** publishers
...
| [By platform](./platforms/README.md) | macOS (3077) · Windows (804) · cross-platform (775), each by category |
| [By publisher](./publishers/README.md) | 2059 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,636 |
