...
**3271** extensions · **17** categories · **2185** publishers
...
| [By platform](./platforms/README.md) | macOS (3239) · Windows (900) · cross-platform (868), each by category |
| [By publisher](./publishers/README.md) | 2185 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,735 |
