...
**3190** extensions · **17** categories · **2128** publishers
...
| [By platform](./platforms/README.md) | macOS (3158) · Windows (859) · cross-platform (827), each by category |
| [By publisher](./publishers/README.md) | 2128 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,686 |
