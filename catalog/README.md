...
**3316** extensions · **17** categories · **2223** publishers
...
| [By platform](./platforms/README.md) | macOS (3281) · Windows (927) · cross-platform (892), each by category |
| [By publisher](./publishers/README.md) | 2223 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,764 |
