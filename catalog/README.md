...
**3272** extensions · **17** categories · **2187** publishers
...
| [By platform](./platforms/README.md) | macOS (3240) · Windows (901) · cross-platform (869), each by category |
| [By publisher](./publishers/README.md) | 2187 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,736 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,440 |
| Creative & Media | Design Tools, Media | 430 |
| Web, Finance & News | Web, Finance, News | 675 |
| System & Utilities | System, Other | 449 |
