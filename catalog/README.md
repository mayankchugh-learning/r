...
**3149** extensions · **17** categories · **2095** publishers
...
| [By platform](./platforms/README.md) | macOS (3117) · Windows (829) · cross-platform (797), each by category |
| [By publisher](./publishers/README.md) | 2095 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,665 |
