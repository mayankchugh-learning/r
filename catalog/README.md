...
**3256** extensions · **17** categories · **2173** publishers
...
| [By platform](./platforms/README.md) | macOS (3224) · Windows (894) · cross-platform (862), each by category |
| [By publisher](./publishers/README.md) | 2173 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,727 |
