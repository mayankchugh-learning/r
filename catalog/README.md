...
**3257** extensions · **17** categories · **2174** publishers
...
| [By platform](./platforms/README.md) | macOS (3225) · Windows (894) · cross-platform (862), each by category |
| [By publisher](./publishers/README.md) | 2174 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,728 |
