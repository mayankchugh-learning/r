...
**3204** extensions · **17** categories · **2138** publishers
...
| [By platform](./platforms/README.md) | macOS (3172) · Windows (868) · cross-platform (836), each by category |
| [By publisher](./publishers/README.md) | 2138 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,696 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,415 |
