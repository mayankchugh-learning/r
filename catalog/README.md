...
**3253** extensions · **17** categories · **2170** publishers
...
| [By platform](./platforms/README.md) | macOS (3221) · Windows (891) · cross-platform (859), each by category |
| [By publisher](./publishers/README.md) | 2170 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,724 |
