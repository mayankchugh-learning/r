...
**3128** extensions · **17** categories · **2076** publishers
...
| [By platform](./platforms/README.md) | macOS (3098) · Windows (813) · cross-platform (783), each by category |
| [By publisher](./publishers/README.md) | 2076 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,651 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,388 |
| Creative & Media | Design Tools, Media | 408 |
| Web, Finance & News | Web, Finance, News | 655 |
