...
**3289** extensions · **17** categories · **2203** publishers
...
| [By platform](./platforms/README.md) | macOS (3255) · Windows (909) · cross-platform (875), each by category |
| [By publisher](./publishers/README.md) | 2203 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,748 |
