...
**3254** extensions · **17** categories · **2171** publishers
...
| [By platform](./platforms/README.md) | macOS (3222) · Windows (893) · cross-platform (861), each by category |
| [By publisher](./publishers/README.md) | 2171 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,725 |
