...
**3246** extensions · **17** categories · **2164** publishers
...
| [By platform](./platforms/README.md) | macOS (3214) · Windows (889) · cross-platform (857), each by category |
| [By publisher](./publishers/README.md) | 2164 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,719 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,431 |
