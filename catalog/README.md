...
**3286** extensions · **17** categories · **2201** publishers
...
| [By platform](./platforms/README.md) | macOS (3252) · Windows (907) · cross-platform (873), each by category |
| [By publisher](./publishers/README.md) | 2201 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,745 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,445 |
| Creative & Media | Design Tools, Media | 432 |
