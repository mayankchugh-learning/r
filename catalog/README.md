...
**3261** extensions · **17** categories · **2178** publishers
...
| [By platform](./platforms/README.md) | macOS (3229) · Windows (895) · cross-platform (863), each by category |
| [By publisher](./publishers/README.md) | 2178 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,730 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,435 |
| Creative & Media | Design Tools, Media | 429 |
| Web, Finance & News | Web, Finance, News | 674 |
