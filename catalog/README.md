...
**3216** extensions · **17** categories · **2145** publishers
...
| [By platform](./platforms/README.md) | macOS (3184) · Windows (875) · cross-platform (843), each by category |
| [By publisher](./publishers/README.md) | 2145 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,704 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,418 |
| Creative & Media | Design Tools, Media | 424 |
| Web, Finance & News | Web, Finance, News | 668 |
| System & Utilities | System, Other | 439 |
