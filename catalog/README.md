...
**3228** extensions · **17** categories · **2153** publishers
...
| [By platform](./platforms/README.md) | macOS (3196) · Windows (881) · cross-platform (849), each by category |
| [By publisher](./publishers/README.md) | 2153 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,710 |
