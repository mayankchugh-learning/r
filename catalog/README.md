...
**3136** extensions · **17** categories · **2083** publishers
...
| [By platform](./platforms/README.md) | macOS (3106) · Windows (819) · cross-platform (789), each by category |
| [By publisher](./publishers/README.md) | 2083 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,655 |
