...
**3130** extensions · **17** categories · **2077** publishers
...
| [By platform](./platforms/README.md) | macOS (3100) · Windows (814) · cross-platform (784), each by category |
| [By publisher](./publishers/README.md) | 2077 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,652 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,389 |
| Creative & Media | Design Tools, Media | 409 |
