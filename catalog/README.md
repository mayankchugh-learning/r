...
**3175** extensions · **17** categories · **2118** publishers
...
| [By platform](./platforms/README.md) | macOS (3143) · Windows (848) · cross-platform (816), each by category |
| [By publisher](./publishers/README.md) | 2118 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,679 |
