...
**3317** extensions · **17** categories · **2224** publishers
...
| [By platform](./platforms/README.md) | macOS (3282) · Windows (928) · cross-platform (893), each by category |
| [By publisher](./publishers/README.md) | 2224 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,765 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,457 |
| Creative & Media | Design Tools, Media | 434 |
| Web, Finance & News | Web, Finance, News | 680 |
