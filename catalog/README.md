...
**3291** extensions · **17** categories · **2204** publishers
...
| [By platform](./platforms/README.md) | macOS (3257) · Windows (912) · cross-platform (878), each by category |
| [By publisher](./publishers/README.md) | 2204 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,750 |
