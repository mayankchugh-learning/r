...
**3135** extensions · **17** categories · **2082** publishers
...
| [By platform](./platforms/README.md) | macOS (3105) · Windows (818) · cross-platform (788), each by category |
| [By publisher](./publishers/README.md) | 2082 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,654 |
