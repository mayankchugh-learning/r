...
**3206** extensions · **17** categories · **2140** publishers
...
| [By platform](./platforms/README.md) | macOS (3174) · Windows (869) · cross-platform (837), each by category |
| [By publisher](./publishers/README.md) | 2140 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,698 |
