...
**3172** extensions · **17** categories · **2116** publishers
...
| [By platform](./platforms/README.md) | macOS (3140) · Windows (846) · cross-platform (814), each by category |
| [By publisher](./publishers/README.md) | 2116 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,678 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,403 |
