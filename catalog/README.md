...
**3307** extensions · **17** categories · **2217** publishers
...
| [By platform](./platforms/README.md) | macOS (3272) · Windows (924) · cross-platform (889), each by category |
| [By publisher](./publishers/README.md) | 2217 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,758 |
