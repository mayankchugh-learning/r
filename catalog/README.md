...
**3196** extensions · **17** categories · **2132** publishers
...
| [By platform](./platforms/README.md) | macOS (3164) · Windows (863) · cross-platform (831), each by category |
| [By publisher](./publishers/README.md) | 2132 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,690 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,412 |
