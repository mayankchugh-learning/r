...
**3284** extensions · **17** categories · **2199** publishers
...
| [By platform](./platforms/README.md) | macOS (3250) · Windows (906) · cross-platform (872), each by category |
| [By publisher](./publishers/README.md) | 2199 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,744 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,444 |
