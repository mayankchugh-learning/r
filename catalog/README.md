...
**3137** extensions · **17** categories · **2084** publishers
...
| [By platform](./platforms/README.md) | macOS (3106) · Windows (820) · cross-platform (789), each by category |
| [By publisher](./publishers/README.md) | 2084 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,656 |
