...
**3140** extensions · **17** categories · **2087** publishers
...
| [By platform](./platforms/README.md) | macOS (3109) · Windows (822) · cross-platform (791), each by category |
| [By publisher](./publishers/README.md) | 2087 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,659 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,390 |
| Creative & Media | Design Tools, Media | 411 |
