...
**3147** extensions · **17** categories · **2093** publishers
...
| [By platform](./platforms/README.md) | macOS (3115) · Windows (828) · cross-platform (796), each by category |
| [By publisher](./publishers/README.md) | 2093 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,664 |
