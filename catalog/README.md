...
**3283** extensions · **17** categories · **2198** publishers
...
| [By platform](./platforms/README.md) | macOS (3249) · Windows (906) · cross-platform (872), each by category |
| [By publisher](./publishers/README.md) | 2198 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,743 |
