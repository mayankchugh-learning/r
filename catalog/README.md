...
**3146** extensions · **17** categories · **2092** publishers
...
| [By platform](./platforms/README.md) | macOS (3114) · Windows (827) · cross-platform (795), each by category |
| [By publisher](./publishers/README.md) | 2092 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,663 |
