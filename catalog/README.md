...
**3226** extensions · **17** categories · **2151** publishers
...
| [By platform](./platforms/README.md) | macOS (3194) · Windows (881) · cross-platform (849), each by category |
| [By publisher](./publishers/README.md) | 2151 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,709 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,423 |
| Creative & Media | Design Tools, Media | 425 |
| Web, Finance & News | Web, Finance, News | 668 |
| System & Utilities | System, Other | 441 |
