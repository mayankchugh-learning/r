...
**3224** extensions · **17** categories · **2150** publishers
...
| [By platform](./platforms/README.md) | macOS (3192) · Windows (880) · cross-platform (848), each by category |
| [By publisher](./publishers/README.md) | 2150 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,708 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,422 |
| Creative & Media | Design Tools, Media | 425 |
| Web, Finance & News | Web, Finance, News | 668 |
| System & Utilities | System, Other | 440 |
