...
**3107** extensions · **17** categories · **2060** publishers
...
| [By platform](./platforms/README.md) | macOS (3078) · Windows (804) · cross-platform (775), each by category |
| [By publisher](./publishers/README.md) | 2060 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,637 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,378 |
