...
**3138** extensions · **17** categories · **2085** publishers
...
| [By platform](./platforms/README.md) | macOS (3107) · Windows (821) · cross-platform (790), each by category |
| [By publisher](./publishers/README.md) | 2085 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,657 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,390 |
| Creative & Media | Design Tools, Media | 410 |
| Web, Finance & News | Web, Finance, News | 657 |
| System & Utilities | System, Other | 430 |
