...
**3273** extensions · **17** categories · **2188** publishers
...
| [By platform](./platforms/README.md) | macOS (3241) · Windows (901) · cross-platform (869), each by category |
| [By publisher](./publishers/README.md) | 2188 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,737 |
