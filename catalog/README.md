...
**3244** extensions · **17** categories · **2163** publishers
...
| [By platform](./platforms/README.md) | macOS (3212) · Windows (889) · cross-platform (857), each by category |
| [By publisher](./publishers/README.md) | 2163 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,718 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,430 |
