...
**3181** extensions · **17** categories · **2123** publishers
...
| [By platform](./platforms/README.md) | macOS (3149) · Windows (851) · cross-platform (819), each by category |
| [By publisher](./publishers/README.md) | 2123 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,681 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,407 |
| Creative & Media | Design Tools, Media | 420 |
| Web, Finance & News | Web, Finance, News | 661 |
