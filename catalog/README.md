...
**3321** extensions · **17** categories · **2228** publishers
...
| [By platform](./platforms/README.md) | macOS (3285) · Windows (932) · cross-platform (896), each by category |
| [By publisher](./publishers/README.md) | 2228 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,767 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,458 |
