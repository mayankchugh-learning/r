...
**3318** extensions · **17** categories · **2225** publishers
...
| [By platform](./platforms/README.md) | macOS (3282) · Windows (930) · cross-platform (894), each by category |
| [By publisher](./publishers/README.md) | 2225 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,766 |
