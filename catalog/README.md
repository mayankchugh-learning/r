...
**3154** extensions · **17** categories · **2100** publishers
...
| [By platform](./platforms/README.md) | macOS (3122) · Windows (832) · cross-platform (800), each by category |
| [By publisher](./publishers/README.md) | 2100 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,669 |
