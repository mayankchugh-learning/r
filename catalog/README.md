...
**3314** extensions · **17** categories · **2222** publishers
...
| [By platform](./platforms/README.md) | macOS (3279) · Windows (926) · cross-platform (891), each by category |
| [By publisher](./publishers/README.md) | 2222 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,763 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,456 |
