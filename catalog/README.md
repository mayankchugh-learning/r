...
**3220** extensions · **17** categories · **2147** publishers
...
| [By platform](./platforms/README.md) | macOS (3188) · Windows (878) · cross-platform (846), each by category |
| [By publisher](./publishers/README.md) | 2147 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,707 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,421 |
| Creative & Media | Design Tools, Media | 424 |
