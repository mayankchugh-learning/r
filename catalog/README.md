...
**3108** extensions · **17** categories · **2061** publishers
...
| [By platform](./platforms/README.md) | macOS (3079) · Windows (805) · cross-platform (776), each by category |
| [By publisher](./publishers/README.md) | 2061 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,638 |
