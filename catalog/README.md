...
**3255** extensions · **17** categories · **2172** publishers
...
| [By platform](./platforms/README.md) | macOS (3223) · Windows (893) · cross-platform (861), each by category |
| [By publisher](./publishers/README.md) | 2172 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,726 |
