...
**3105** extensions · **17** categories · **2058** publishers
...
| [By platform](./platforms/README.md) | macOS (3076) · Windows (803) · cross-platform (774), each by category |
| [By publisher](./publishers/README.md) | 2058 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,635 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,377 |
| Creative & Media | Design Tools, Media | 404 |
| Web, Finance & News | Web, Finance, News | 652 |
