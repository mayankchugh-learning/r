...
**3248** extensions · **17** categories · **2166** publishers
...
| [By platform](./platforms/README.md) | macOS (3216) · Windows (889) · cross-platform (857), each by category |
| [By publisher](./publishers/README.md) | 2166 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,720 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,432 |
| Creative & Media | Design Tools, Media | 429 |
| Web, Finance & News | Web, Finance, News | 671 |
| System & Utilities | System, Other | 447 |
