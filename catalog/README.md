...
**3210** extensions · **17** categories · **2142** publishers
...
| [By platform](./platforms/README.md) | macOS (3178) · Windows (870) · cross-platform (838), each by category |
| [By publisher](./publishers/README.md) | 2142 publishers, sortable by downloads or extension count; big publishers get their own page |
...
| --- | --- | --- |
| Work & Productivity | Productivity, Applications, Communication | 1,700 |
| Development | Developer Tools, AI, Documentation, Data, Security | 1,416 |
| Creative & Media | Design Tools, Media | 423 |
