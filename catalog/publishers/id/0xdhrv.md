...
11 extensions · 1,230 downloads · [store](https://www.raycast.com/0xdhrv) · [← publishers](../README.md)
...
| [Integrations.sh](https://github.com/raycast/extensions/tree/main/extensions/integrations-sh) | 41 | Search integrations.sh for MCP, OpenAPI, GraphQL, and CLI integration surfaces, and inspect setup and credentials per domain. | 0xdhrv | macOS, Windows | [store](https://www.raycast.com/0xdhrv/integrations-sh) |
